...
public class AckTest {
    ...
    void setUp() {
        client = new RedisBridgeClient() {
            ...
            public MessageRouter.Settings routerSettings() {
                return new MessageRouter.Settings(false, -1, 3, 5);
            }
        };
    ...
    void testAckTimeoutWhenNoReceiver() {
        ...
        CompletableFuture<Packet<AckEnabledMessage>> fut = client.getRedisRouter()
    ...
    void testNoAckRequestedPublishesImmediately() {
        TestMessage msg = new TestMessage("no-ack");
