...
public class RedisBridgeIntegrationTest {
    ...
    void testSimpleMessageRegistration() {
        assertDoesNotThrow(() -> {
            client.getMessageRegistry()
                    .register(UserLoginMessage.class)
        ...
        assertTrue(client.getMessageRegistry().isRegistered(UserLoginMessage.NAMESPACE));
    }
    ...
    void testMessageRegistrationWithResponse() {
        ...
        assertTrue(client.getMessageRegistry().isRegistered(TestMessage.NAMESPACE));
    }
    ...
    void testPublishAndReceiveMessage() throws InterruptedException {
        ...
        UserLoginMessage message = new UserLoginMessage("testUser", System.currentTimeMillis());
        client.getRedisRouter().publish(message, client.platformEntity());

        assertTrue(latch.await(5, TimeUnit.SECONDS), "Packet should be received within 5 seconds");
    ...
    void testRequestResponsePattern() throws InterruptedException {
        ...
        client.getRedisRouter()
                .<TestMessage, TestResponse>waitResponse(new TestMessage("Hello"), client.platformEntity())
